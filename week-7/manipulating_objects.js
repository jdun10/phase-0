...
terah = {
  ...
  weight: 125,
  eyeColor: "",
  var children = {carson: "Carson", carter: "Carter", colton: "Colton"}
}
...
//  I had trouble setting up this challenge and understanding what it wanted me to actually alter outside of the objects terah and adam. Is node different from how we normally run our code?

// How difficult was it to add and delete properties outside of the object itself?
//  I don't think that it was difficult to change properties outside of the object, but I think that you need to remind yourself of the code that has been changed elsewhere or you could be confused by where the data is coming from.

// What did you learn about manipulating objects in this challenge?
//  I learned that objects must always be called by what you assign them to. They could be called by their object name or their index name, but you need to stick with whatever you decide to call them throughout the program.
//
//
//
